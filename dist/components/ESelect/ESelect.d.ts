...
declare const configuration: {
    readonly name: ComponentName.ESelect;
    readonly props: {
        readonly variant: {
...
type ESelect = ComponentConfiguration<typeof configuration, BlockSlots & ComponentSlots & DisabledSlots & InputFieldSlots & VariantSlots>;
declare const ESelect: import("vue").DefineComponent<{
    readonly variant: {
        readonly _preset: true;
        readonly type: PropType<string>;
    };
