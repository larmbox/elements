...
declare const configuration: {
    readonly name: ComponentName.ESwitch;
    readonly props: {
        readonly variant: {
    ...
    readonly style: {
        ...
        readonly 'toggle-background-color': "var(--border-color)";
...
type ESwitch = ComponentConfiguration<typeof configuration, BlockSlots & ComponentSlots & DisabledSlots & InputSlots & VariantSlots>;
declare const ESwitch: import("vue").DefineComponent<{
    readonly variant: {
        readonly _preset: true;
        readonly type: PropType<string>;
    };
