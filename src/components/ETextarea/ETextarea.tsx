      ...
      >
        ...
        <div class={css.element('inner')}>
          <textarea
            ...
            style={{ resize: props.value.resize }}
            cols={props.value.cols}
